...
if(isset($_POST['salary_save'])) {
  ...
  $detail  = $_POST['detail'];
  $date  = $_POST['date'];
  $add_salary = mysqli_query($connection, "INSERT INTO `salary_pay` (`pay_id`, `employee_id`, `payable`, `amount`,`currency`,`rate`, `removal_amount`, `detail`, `date`) VALUES (NULL, '$name', '$payable', '$amount','$currency','$rate', '$removal_amount', '$detail', '$date')");
  if($add_salary) {
                ...
                <input type="number" class="form-control" id="payable" name="payable" oninvalid="this.setCustomValidity('این اطلاعات الزامی میباشد.')" oninput="this.setCustomValidity('')" required>
                  ...
                  <div class="form-group" style="position: relative;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="quantity" id="quantity" placeholder="نرخ" oninvalid="this.setCustomValidity('این اطلاعات الزامی میباشد.')" oninput="this.setCustomValidity('')" required>
                    </div>
