            ...
            <div class="box box-primary">
              ...
              <?php
                                    ...
                                    if(isset($_POST["by_date_submit"])){
                                        ...
                                        // for sales sum
                                        $sql_query_01 = mysqli_query($connection,"SELECT SUM(sale_detail.comission+sale_detail.price) as total_price,SUM(sale_detail.comission) as total_pure_price FROM sale_detail WHERE sale_detail.date between '$from_date' and '$to_date' ");   
                                        // for sales payment
                                      ...
                                      // for sales sum
                                        $sql_query_01 = mysqli_query($connection,"SELECT SUM(sale_detail.comission+sale_detail.price) as total_price,SUM(sale_detail.comission) as total_pure_price FROM sale_detail");   
                                      // for sales payment
                                      ...
                                      // for total visa total price
                                        ...
                                        $sql_query_08 = mysqli_query($connection,"SELECT sum((salary_pay.payable/salary_pay.rate)) as salary_total from salary_pay"); 
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <?php
                    echo round($fetch_01["total_price"],2) . ' $ ';
                  ?>
                  </span>
                </div>
                <!-- /.info-box-content -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                  <?php
                    echo round($fetch_02["total_payment_price"],2) . ' $ ';
                  ?>
                  </span>
                </div>
                <!-- /.info-box-content -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                    <?php
                      echo round($fetch_01["total_pure_price"],2);
                    ?>
                    <small>$</small>
                  </span>
                </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                  <?php
                    echo round($fetch_05["total_payment_price"],2) . ' $ ';
                  ?>
                  </span>
                </div>
                <!-- /.info-box-content -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  echo round($fetch_04['pure_visa'],2);
                  ?>
                  <small>$</small>
                  </span>
                </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                  <?php echo round($fetch_01['total_pure_price']+ $fetch_04['pure_visa'],2); ?>
                  <small>$</small>
                  </span>
                </div>
                <!-- /.info-box-content -->
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo round($fetch_06['total_expense'],2); ?> <small>$</small></span>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <!-- /.col -->
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo round($fetch_08['salary_total'],2); ?> <small>$</small></span>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
