          ...
          <table id="expenses-table" class="table table-bordered table-striped col-sm-12">
            ...
            ?>
              <tr>
                  ...
                  if($row['currency'] == 2)
                  {
                    $total_usd = $total_usd + $row['amount'];
                  }
                  else
                  {
                    $total_afghani = $total_afghani + $row['amount'];
                  }
                  echo $row_04['currency'] ?></td>
          ...
          <table style="width: 100%; text-align: center;">
            <tfoot style="background-color: rgb(44, 44, 44); color: white;">
              <tr>
                  ...
                  echo round($row_total['total_exp'],2) . " USD";  ?></th>

                  <th style="padding: 8px 20px;">مصارف دالری : <?php                   
               
                  
                  echo round($total_usd,2) . " USD";  ?></th>
                  <th style="padding: 8px 20px;">مصارف افغانی : <?php                   
               
                  
               echo round($total_afghani,2) . " AFN";  ?></th>
