 ...
 * @author Monir Ahmadyar Ph.Number 0798 045 829 -- 0771 838 034
 * @version 1.0
 */
/**
...
$sql_query_02 = mysqli_query($connection,"select backup_address from info where info_id='1'");
$fetch_02 = mysqli_fetch_assoc($sql_query_02);
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'travel_agency');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", $fetch_02["backup_address"]); // Comment this line to use same script's directory ('.')
...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
        ...
        $this->backupFile               = date_default_timezone_set("Asia/Kabul");;
        $this->backupFile              = 'Backup-'.$this->dbName.'-'.date('Y-m-d h-i-sa',time()).'.sql';
...
$backupDatabase = new Backup_Database("localhost", "root", "", "travel_agency","utf8");
$result = $backupDatabase->backupTables(TABLES, BACKUP_DIR) ? 'Data was successfully backed up' : 'KO';
