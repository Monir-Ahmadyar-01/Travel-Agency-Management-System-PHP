    ...
    <div class="box box-info" style="border: 1px solid rgb(199, 196, 196); border-radius: 1%; padding: 3px;">
       ...
       <div class="box-body table-responsive">
         <table id="employees-table" class="table table-bordered table-striped col-sm-12">
           ...
           <tbody>
           <?php 
    $show_salary_query = mysqli_query($connection, "SELECT *,(select `name` from staff where salary_pay.employee_id = staff.staff_id) as name_staff FROM `salary_pay`");
    $count =1 ;
         ...
         <table style="width: 100%; text-align: center;">
          <tfoot style="background-color: rgb(44, 44, 44); color: white;">
            <tr>
                ...
                <?php
                 $sum_of_salary = mysqli_query($connection, "SELECT SUM(salary_pay.amount) as total_salary, sum(salary_pay.removal_amount) as total_r from salary_pay");
                $row_t = mysqli_fetch_assoc($sum_of_salary);
                ?>
                مجموعه معاشات : 
                <?php
                  echo $row_t['total_salary'];
                ?>
                </th>
                ...
                <?php
                  echo $row_t['total_salary'] - $row_t['total_r'];
                ?>
                 </th>
            </tr>
        </tfoot>
